#!/c/gcdev/gnucash-2.6.10/mingw/msys/1.0/bin/perl
...
## Configuration
# Commands
$WGET = "/c/gcdev/gnucash-2.6.10/mingw/msys/1.0/bin/wget";
$LYNX = "NO";
#$SED = "/c/gcdev/gnucash-2.6.10/mingw/msys/1.0/bin/sed";
$GREP = "/c/gcdev/gnucash-2.6.10/mingw/msys/1.0/bin/grep";
$RECODE = "NO"; #"NO"; -- dont use recode, it is not widely available
# Directories
$prefix="/c/gcdev/gnucash-2.6.10/gwenhywfar";
